...
--
-- Host: localhost:3306
-- Generation Time: Jan 03, 2024 at 09:55 PM
...
(1, 1, 'email_password', 'Atha Nabil', 'thalalatha13@gmail.com', '$2y$12$mJWVZw8ySA3KnlVDzIIapeAgP5zcSvDISkEeyBcsQRYEeT9sPFzz.', NULL, NULL, 0, '2024-01-03 14:37:54', '2023-12-14 06:05:18', '2024-01-03 14:37:55'),
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `customer_kode_transaksi_foreign` (`kode_transaksi`)
...
DROP TABLE IF EXISTS `layanan_servis`;
...
(1, 'ryzntxx', NULL, NULL, 0, '2024-01-03 14:54:32', '2023-12-14 06:05:17', '2023-12-14 10:38:19', NULL, 'Ryzntx', NULL, NULL),
